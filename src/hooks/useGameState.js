    ...
    apiGetPublicConfig().then(({ data: pubCfg }) => {
      if (pubCfg?.config && mounted.current) {
        ...
        setLimits(prev => ({
          ...
          quizQuestionCooldown: cfg.quiz_question_cooldown !== undefined ? +cfg.quiz_question_cooldown : prev.quizQuestionCooldown,
          quizCardCooldown:  cfg.quiz_card_cooldown !== undefined ? +cfg.quiz_card_cooldown : prev.quizCardCooldown,
          ...
          maxActiveListingsByRarity: cfg.max_active_listings_by_rarity ?? prev.maxActiveListingsByRarity,
          ...
          forceShinyCount:  cfg.force_shiny_count !== undefined ? +cfg.force_shiny_count : prev.forceShinyCount,
          ...
          quizConsolationForgeByRarity: cfg.quiz_consolation_forge_by_rarity ?? prev.quizConsolationForgeByRarity,
          quizDailyForgeCap:   cfg.quiz_daily_forge_cap   !== undefined ? +cfg.quiz_daily_forge_cap   : prev.quizDailyForgeCap,
          quizWeeklyCapRare:       cfg.quiz_weekly_cap_rare       !== undefined ? +cfg.quiz_weekly_cap_rare       : prev.quizWeeklyCapRare,
          quizWeeklyCapEpique:     cfg.quiz_weekly_cap_epique     !== undefined ? +cfg.quiz_weekly_cap_epique     : prev.quizWeeklyCapEpique,
          quizWeeklyCapLegendaire: cfg.quiz_weekly_cap_legendaire !== undefined ? +cfg.quiz_weekly_cap_legendaire : prev.quizWeeklyCapLegendaire,
          marketWeeklyNewCap:      cfg.market_weekly_new_cap      !== undefined ? +cfg.market_weekly_new_cap      : prev.marketWeeklyNewCap,
          patronageWeeklyCapRare:       cfg.patronage_weekly_cap_rare       !== undefined ? +cfg.patronage_weekly_cap_rare       : prev.patronageWeeklyCapRare,
          patronageWeeklyCapEpique:     cfg.patronage_weekly_cap_epique     !== undefined ? +cfg.patronage_weekly_cap_epique     : prev.patronageWeeklyCapEpique,
          patronageWeeklyCapLegendaire: cfg.patronage_weekly_cap_legendaire !== undefined ? +cfg.patronage_weekly_cap_legendaire : prev.patronageWeeklyCapLegendaire,
          patronageRewardPfRare:        cfg.patronage_reward_pf_rare        !== undefined ? +cfg.patronage_reward_pf_rare        : prev.patronageRewardPfRare,
          patronageRewardPfEpique:      cfg.patronage_reward_pf_epique      !== undefined ? +cfg.patronage_reward_pf_epique      : prev.patronageRewardPfEpique,
          patronageRewardPfLegendaire:  cfg.patronage_reward_pf_legendaire  !== undefined ? +cfg.patronage_reward_pf_legendaire  : prev.patronageRewardPfLegendaire,
          patronageNewDays:             cfg.patronage_new_days              !== undefined ? +cfg.patronage_new_days              : prev.patronageNewDays,
          patronageOldDays:             cfg.patronage_old_days              !== undefined ? +cfg.patronage_old_days              : prev.patronageOldDays,
          patronageFastSeconds:         cfg.patronage_fast_seconds          !== undefined ? +cfg.patronage_fast_seconds          : prev.patronageFastSeconds,
          patronageCollectionThreshold: cfg.patronage_collection_threshold  !== undefined ? +cfg.patronage_collection_threshold  : prev.patronageCollectionThreshold,
          patronageMinGeocoins:         cfg.patronage_min_geocoins          !== undefined ? +cfg.patronage_min_geocoins          : prev.patronageMinGeocoins,
          patronageSeenDays:            cfg.patronage_seen_days             !== undefined ? +cfg.patronage_seen_days             : prev.patronageSeenDays,
          patronageChoiceSeconds:       cfg.patronage_choice_seconds        !== undefined ? +cfg.patronage_choice_seconds        : prev.patronageChoiceSeconds,
          patronageCriteriaEnabled:     cfg.patronage_criteria_enabled      ?? prev.patronageCriteriaEnabled,
          patronageTestRecipient:       cfg.patronage_test_recipient        ?? prev.patronageTestRecipient,
          patronageDuplicateEnabled:    cfg.patronage_duplicate_enabled     ?? prev.patronageDuplicateEnabled,
          patronageDailyCapCommun:      cfg.patronage_daily_cap_commun      !== undefined ? +cfg.patronage_daily_cap_commun      : prev.patronageDailyCapCommun,
          patronagePointsCommun:        cfg.patronage_points_commun         !== undefined ? +cfg.patronage_points_commun         : prev.patronagePointsCommun,
          patronagePointsRare:          cfg.patronage_points_rare           !== undefined ? +cfg.patronage_points_rare           : prev.patronagePointsRare,
          patronagePointsEpique:        cfg.patronage_points_epique         !== undefined ? +cfg.patronage_points_epique         : prev.patronagePointsEpique,
          patronagePointsLegendaire:    cfg.patronage_points_legendaire     !== undefined ? +cfg.patronage_points_legendaire     : prev.patronagePointsLegendaire,
          forgeCostByRarity:   cfg.forge_cost_by_rarity  ?? prev.forgeCostByRarity,
          forgeSale:           cfg.forge_sale            ?? prev.forgeSale,
          ...
          holdReplacePrice:    cfg.hold_replace_price  !== undefined ? +cfg.hold_replace_price  : prev.holdReplacePrice,
          pocketBoostPrice:    cfg.pocket_boost_price  !== undefined ? +cfg.pocket_boost_price  : prev.pocketBoostPrice,
          pocketBoostCards:    cfg.pocket_boost_cards  !== undefined ? +cfg.pocket_boost_cards  : prev.pocketBoostCards,
          bagSlotPrices:       cfg.bag_slot_prices     ?? prev.bagSlotPrices,
          shinyBagSlotPrices:  cfg.shiny_bag_slot_prices ?? prev.shinyBagSlotPrices,
