...
export default function AdminCards({ cardPool, cardTypes, onAddCard, onEditCard, onDeleteCard, onUpdateCardInPool, setMsg, imgUpload }) {
  ...
  const [nc, setNc] = useState({ name: "", type: cardTypes[0] || "", rarity: "commun", image: null, thumbnail: null, desc: "", sellable: true, minPrice: "", forgeable: false, forgeCost: "", shiny_forge_cost: null });
        ...
        <div style={{display:"flex",gap:20,flexWrap:"wrap"}}>
          <div style={{flex:1,minWidth:240}}>
            ...
            <Fld lbl="Forge">
              ...
              <div style={{color:"#555",fontSize:10,marginTop:4}}>Exclue du quiz · non vendable · craftable avec des points de forge</div>
