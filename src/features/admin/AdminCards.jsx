      ...
      {!editCard && !newCardMode && (
        <>
          ...
          {displayCards.length === 0
            ? <div style={{color:"#8899aa",fontSize:13,textAlign:"center",padding:"30px 0",fontStyle:"italic"}}>Aucun geocoin trouvé.</div>
            : (()=>{
        ...
        <div style={{display:"flex",gap:20,flexWrap:"wrap"}}>
          <div style={{flex:1,minWidth:240}}>
            ...
            <Fld lbl="Forge">
              ...
              <div style={{color:"#8899aa",fontSize:10,marginTop:4}}>Exclue du quiz · non vendable · craftable avec des points de forge</div>
