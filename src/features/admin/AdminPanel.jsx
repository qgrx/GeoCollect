            ...
            <table style={{width:"100%",borderCollapse:"collapse",fontSize:12}}>
              ...
              <tbody>
                {[
                  ...
                  ["🎁 Mécénat — éligibilité du bénéficiaire", <><span style={{color:"#aaa"}}>Vu depuis &lt;</span> <input type="number" min={1} value={limEdit.patronageSeenDays??7} onChange={e=>setLimEdit({...limEdit,patronageSeenDays:Math.max(1,+e.target.value)})} style={{...INP,width:48}}/> <span style={{color:"#aaa"}}>j · Min</span> <input type="number" min={0} value={limEdit.patronageMinGeocoins??10} onChange={e=>setLimEdit({...limEdit,patronageMinGeocoins:Math.max(0,+e.target.value)})} style={{...INP,width:48}}/> <span style={{color:"#aaa"}}>geocoins</span></>, "Restreint le pool de bénéficiaires : seuls les joueurs connectés / récemment connectés (vus depuis moins de N jours, on privilégie toujours les plus récents) ET possédant au moins N geocoins peuvent recevoir un don."],
