      ...
      {playerView?(
        <div>
          ...
          <div style={{marginTop:14,display:"flex",gap:8,flexWrap:"wrap"}}>
            ...
            {playerView.status!=="supprimé"&&!playerView.deleted_at&&(<div style={{fontSize:10,color:"#a8bfcf",alignSelf:"center"}}>Compte actif — le joueur peut se désactiver depuis ses paramètres</div>)}
          </div>
