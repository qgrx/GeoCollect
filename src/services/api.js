...
export const apiAdminAddQuestion        = (q, a, translations, alt_answers, hidden = false) => apiFetch('/api/admin/questions', { method: 'POST', body: { question: q, answer: a, hint: '', translations: translations || {}, alt_answers: alt_answers || [], hidden } })
...
export const apiAdminEditFullQuestion   = (id, fields)               => apiFetch(`/api/admin/questions/${id}`, { method: 'PATCH', body: { question: fields.q, answer: fields.a, hint: fields.hint || '', alt_answers: fields.alt_answers || [], ...(fields.hidden !== undefined ? { hidden: fields.hidden } : {}) } })
