...
export const INIT_LIMITS = {
  ...
  patronageRewardPfRare:        1,
  patronageRewardPfEpique:      5,
  patronageRewardPfLegendaire:  100,
  patronageNewDays:             30,
  patronageOldDays:             30,
  ...
  patronageDuplicateEnabled:    true,
  patronageDailyCapCommun:      2,
  patronagePointsCommun:        1,
  patronagePointsRare:          2,
  patronagePointsEpique:        7,
  patronagePointsLegendaire:    20,
  ...
  holdRentPrice:        80,
  holdReplacePrice:     50,
  pocketBoostPrice:     100,
  pocketBoostCards:     10,
  bagSlotPrices:        [500, 1000, 2000, 4000, 6000],
  shinyBagSlotPrices:   [200, 400, 600],
